...
export default function PromoBanners() {
    return (
        <section className="max-w-[1440px] mx-auto px-10 py-12 grid grid-cols-1 md:grid-cols-2 gap-8 font-sans">

            <div className="relative group overflow-hidden rounded-[40px] h-[340px] flex items-center bg-[#FDF2D2]">
                ...
                <div className="relative z-10 w-full flex items-center px-14 gap-10">
                    <div className="w-1/2 flex justify-center transform group-hover:scale-110 transition-transform duration-700">
                            <img
                                src={Bakery}
                                alt="Promo Asset"
                    ...
                    <div className="w-1/2 space-y-5">
                        <h3 className="text-[32px] font-black text-slate-800 leading-[1.1] tracking-tight">
            ...
            <div className="relative group overflow-hidden rounded-[40px] h-[340px] flex items-center bg-[#FDEEEE]">
                {/* Triple Diagonal Background Shapes */}
                <div className="absolute inset-0 bg-white/40 skew-x-[-35deg] translate-x-[-10%] z-0" />
                <div className="absolute inset-0 bg-white/20 skew-x-[-35deg] translate-x-[40%] z-0" />
