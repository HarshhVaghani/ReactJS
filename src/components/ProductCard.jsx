...
const ProductCard = ({ data, mode = "product" }) => {
  ...
  const inWishlist = wishlistItems.some((p) => p.id === data.id);
            ...
            mode === "product" ? (
              <div className="flex flex-col items-start space-y-2 mt-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center justify-center bg-transparent hover:bg-gray-200 border border-black rounded-base p-2 transition-colors duration-200"
                    onClick={() =>
                      disptch(
                        inWishlist
                  ...
                  >
                    <img
                      src={inWishlist ? heartFilled : heartOutline}
                      alt="wishlist"
                      className="w-5 h-5 transition-all duration-200 ease-in-out active:scale-125"
                    />
                  </button>
                </div>
              </div>
              ...
              <div className="flex items-center justify-between mt-6">
                ...
                <div className="flex space-x-2">
                  ...
                  <button
                    type="button"
                    className="inline-flex items-center bg-fg-danger hover:bg-red-600 box-border border focus:ring-4 focus:ring-danger-medium shadow-xs font-medium leading-5 rounded-base text-sm px-3 py-2 focus:outline-none  border-black"
                    onClick={() => disptch(removeFromWishlist(data.id))}
                  >
                    Remove
                  </button>
                </div>
